...
class PostProcessor:
    ...
    def build_configuration_bundle(self, overrides=None):
        ...
        # Only keys already in the bundle (from Stages 1–3) are accepted;
        # unknown keys are silently ignored to keep the bundle predictable.
        ...
        for key, value in overrides.items():
            if key in bundle:
                ...
                Path.Log.debug(f"Override key '{key}' not in bundle, ignoring")
